...
export const modalButtonLayout = 'flex items-center justify-center py-2.5 px-5 ms-3 p-0.5 rounded-md '
...
export const mainPageButtonStyle = clsx(modalButtonLayout, 'text-gray-100 my-2' , 'bg-blue-700 hover:bg-blue-600')
